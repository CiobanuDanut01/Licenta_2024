namespace Licenta
{
    partial class Settings
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtboxRegCom = new TextBox();
            label2 = new Label();
            txtboxCIF = new TextBox();
            label3 = new Label();
            txtboxAdress = new TextBox();
            label4 = new Label();
            txtboxIBAN = new TextBox();
            label5 = new Label();
            txtboxBank = new TextBox();
            label6 = new Label();
            chkboxChangeCred = new CheckBox();
            txtboxUsername = new TextBox();
            label7 = new Label();
            txtboxCurrentPass = new TextBox();
            label8 = new Label();
            txtboxNewPass = new TextBox();
            label9 = new Label();
            btnSaveChck = new Button();
            btnCloseChck = new Button();
            btnClose = new Button();
            btnSave = new Button();
            ...
            txtboxRegCom.TextChanged += txtboxRegCom_TextChanged;
            // 
            // label2
            // 
            ...
            txtboxCIF.TextChanged += txtboxCIF_TextChanged;
            // 
            // label3
            // 
            ...
            txtboxAdress.TextChanged += txtboxAdress_TextChanged;
            // 
            // label4
            // 
            ...
            txtboxIBAN.TextChanged += txtboxIBAN_TextChanged;
            // 
            // label5
            // 
            ...
            txtboxBank.TextChanged += txtboxBank_TextChanged;
            // 
            // label6
            // 
            ...
            chkboxChangeCred.Text = "Doriți să modificați datele de autentificare ?";
            chkboxChangeCred.UseVisualStyleBackColor = true;
            chkboxChangeCred.CheckedChanged += chkboxChangeCred_CheckedChanged;
            // 
            // txtboxUsername
            // 
            ...
            txtboxCurrentPass.TextChanged += txtboxCurrentPass_TextChanged;
            // 
            // label8
            // 
            ...
            txtboxNewPass.TextChanged += txtboxNewPass_TextChanged;
            // 
            // label9
            // 
            ...
            label9.TabIndex = 17;
            label9.Text = "Parola nouă:";
            // 
            // btnSaveChck
            // 
            btnSaveChck.BackColor = Color.FromArgb(116, 86, 174);
            btnSaveChck.Cursor = Cursors.Hand;
            btnSaveChck.FlatAppearance.BorderSize = 0;
            ...
            btnSaveChck.Text = "Salvați";
            btnSaveChck.UseVisualStyleBackColor = false;
            btnSaveChck.Click += btnSaveChck_Click;
            // 
            // btnCloseChck
            // 
            btnCloseChck.BackColor = Color.White;
            btnCloseChck.Cursor = Cursors.Hand;
            ...
            btnCloseChck.Text = "Ieșire";
            btnCloseChck.UseVisualStyleBackColor = false;
            btnCloseChck.Click += btnCloseChck_Click;
            // 
            // btnClose
            // 
            ...
            Controls.Add(btnCloseChck);
            Controls.Add(btnSaveChck);
            Controls.Add(txtboxNewPass);
            Controls.Add(label9);
            Controls.Add(txtboxCurrentPass);
            Controls.Add(label8);
            Controls.Add(txtboxUsername);
            Controls.Add(label7);
            Controls.Add(chkboxChangeCred);
            Controls.Add(txtboxBank);
            Controls.Add(label6);
            Controls.Add(txtboxIBAN);
            Controls.Add(label5);
            Controls.Add(txtboxAdress);
            Controls.Add(label4);
            Controls.Add(txtboxCIF);
            Controls.Add(label3);
            Controls.Add(txtboxRegCom);
            Controls.Add(label2);
        ...
        private TextBox txtboxRegCom;
        private Label label2;
        private TextBox txtboxCIF;
        ...
        private CheckBox chkboxChangeCred;
        private TextBox txtboxUsername;
        private Label label7;
        private TextBox txtboxCurrentPass;
        private Label label8;
        private TextBox txtboxNewPass;
        private Label label9;
        private Button btnSaveChck;
        private Button btnCloseChck;
